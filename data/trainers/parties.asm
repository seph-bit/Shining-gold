...
FalknerGroup:
	...
	db  8, HOOTHOOT,   PECK, FORESIGHT, HYPNOSIS, MUD_SLAP
    db  9, NATU,       PECK, LEER, NIGHT_SHADE, CONFUSION
	db 11, PIDGEOTTO,  QUICK_ATTACK, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
WhitneyGroup:
    ...
    db 20, TEDDIURSA,  SCRATCH, LEER, LICK, FURY_SWIPES
...
BugsyGroup:
	...
	db 15, BEEDRILL,   TACKLE, FOCUS_ENERGY, FURY_ATTACK, TWINEEDLE
	db 16, SHUCKLE,    CONSTRICT, WRAP, WITHDRAW, NO_MOVE
	db 18, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, FALSE_SWIPE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, KOFFING,    SMOG, TACKLE, SELFDESTRUCT, SLUDGE
	db 21, HAUNTER,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 25, MISDREAVUS, PSYWAVE, MEAN_LOOK, GROWL, SHADOW_BALL
	db 26, GENGAR,     DREAM_EATER, MEAN_LOOK, HYPNOSIS, SHADOW_BALL
	db -1 ; end
